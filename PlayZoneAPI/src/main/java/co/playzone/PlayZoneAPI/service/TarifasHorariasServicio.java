...
public class TarifasHorariasServicio {
	...
	public TarifasHorariasDTO crear(CrearTarifaHorariaReq r) {
		...
		// Validación horaInicio
		if (r.horaInicio() == null || r.horaInicio().isBlank()) {
			throw new IllegalArgumentException("Debe especificar horaInicio en formato HH:mm.");
		}
		...
		// Parseo de hora (cada franja es exactamente 1 hora)
