...
public class TarifasHorariasController {
	...
	// ✅ CORREGIDO: ya no filtra en memoria, usa el repositorio
	@GetMapping("/cancha/{canchaId}")
	public List<TarifasHorariasDTO> listarPorCancha(@PathVariable Long canchaId,
			@RequestParam(name = "dia", required = false) Short dia) {

		List<TarifasHorarias> tarifas = (dia == null) ? repo.findByCancha_IdOrderByDiaSemanaAscHoraInicioAsc(canchaId)
				: repo.findByCancha_IdAndDiaSemanaOrderByHoraInicioAsc(canchaId, dia);
